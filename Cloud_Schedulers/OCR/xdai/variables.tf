...
variable "uri" {
  default = "https://compute.googleapis.com/compute/v1/projects/avian-direction-235610/zones/us-central1-a/instances/cl-xdai-ocr-1/reset"
}
variable "scope" {
  default = "https://www.googleapis.com/auth/cloud-platform"
}
variable "node_name" {
  default = "cl-xdai-ocr-1"
}